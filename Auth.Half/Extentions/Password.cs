...
namespace Auth.Half.Extentions;
...
public static class Password
{
    ...
    private const string MyhashV1 = "$MYHASH$V1$";
    ...
    {
        return hashString.Contains(MyhashV1);
    }
    ...
    public static bool Verify(this string password, string hashedPassword)
    {
        ...
        var splittedHashString = hashedPassword.Replace(MyhashV1, "").Split('$');
